      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="space-y-4 font-mono text-sm">
                  <div className="flex items-center space-x-4">
                    ...
                    <span className="text-slate-700 dark:text-gray-300">
                      {t("contact:info.locations.hq")}
                    </span>
                  </div>
                  <div className="flex items-center space-x-4">
                    <span className="text-secondary">02 ::</span>
                    <span className="text-slate-700 dark:text-gray-300">
                      {t("contact:info.locations.uae")}
                    </span>
                  </div>
                  <div className="flex items-center space-x-4">
                    <span className="text-secondary">03 ::</span>
                    <span className="text-slate-700 dark:text-gray-300">
                      {t("contact:info.locations.kuwait")}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <a
                    ...
                    className="block text-xl md:text-2xl font-bold text-slate-900 dark:text-white hover:text-primary transition-colors"
                  >
                    {t("contact:info.email")}
                  </a>
                  <p className="text-slate-500 dark:text-gray-500 font-mono">
          ...
          <div className="lg:col-span-7 mt-12 lg:mt-0">
            <div className="relative">
              ...
              <form
                ...
                className="relative bg-white dark:bg-black/80 backdrop-blur-xl p-8 md:p-12 border border-slate-200 dark:border-white/10 shadow-2xl"
              >
                {/* HUD Corners */}
                    ...
                    <div className="relative">
                      ...
                      >
                        <option value="hosting">
                          {t("contact:form.options.hosting")}
                        </option>
                        <option value="transformation">
                          {t("contact:form.options.transformation")}
                        </option>
                        <option value="webapp">
                          {t("contact:form.options.webapp")}
                        </option>
        ...
        <div className="mt-24">
          <div className="mb-8">
            ...
            <p className="text-center text-sm text-slate-500 dark:text-gray-400 font-mono">
              {t("contact:regional.subtitle")}
            </p>
          </div>
