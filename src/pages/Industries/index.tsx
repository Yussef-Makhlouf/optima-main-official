...
const Industries: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const ogTags = [
      {
        property: "og:title",
        content: `${t("industries:page.title")} | OPTIMA Solutions`,
      },
      {
        property: "og:description",
        content: t("industries:page.seo.description"),
      },
    ...
    <div className="pt-24 md:pt-32 min-h-screen transition-colors bg-white dark:bg-dark">
      ...
      <section className="py-24 md:py-40 relative overflow-hidden grid-bg border-b border-slate-200 dark:border-white/5">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div
            className={`flex items-center ${isRTL ? "flex-row-reverse" : ""} space-x-4 mb-10`}
          >
            <div className="w-12 h-[1px] bg-secondary"></div>
            <span className="text-[10px] font-mono font-bold text-secondary uppercase tracking-[0.6em]">
              {t("industries:page.tag")}
            </span>
          </div>
      ...
      <section className="py-24 md:py-40 bg-slate-50 dark:bg-black/50 border-y border-slate-200 dark:border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 md:mb-24">
            <div
              className={`flex items-center justify-center space-x-4 mb-6 ${isRTL ? "flex-row-reverse" : ""}`}
            >
              ...
              >
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="flex flex-wrap gap-2 mb-2">
                      {project.tags.slice(0, 2).map((tag, i) => (
                        <span
                          key={i}
                          className="text-[10px] font-mono uppercase tracking-wider bg-white/20 backdrop-blur-sm text-white px-2 py-1"
                        >
                          {tag}
                        </span>
                      ))}
                ...
                <div className="p-6">
                  ...
                  >
                    ...
                    <svg
                      className={`w-4 h-4 ml-1 ${isRTL ? "mr-1 ml-0 rotate-180" : ""}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
      ...
      <section className="py-24 md:py-40 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              <div
                className={`flex items-center space-x-4 mb-6 ${isRTL ? "flex-row-reverse" : ""}`}
              >
                <div className="w-12 h-[1px] bg-secondary"></div>
                <span className="text-[10px] font-mono font-bold text-secondary uppercase tracking-[0.4em]">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div
                    key={index}
                    className={`flex items-start group ${isRTL ? "flex-row-reverse text-right" : ""}`}
                  >
              ...
              <div className="relative bg-white dark:bg-black border border-slate-200 dark:border-white/10 p-8 md:p-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="group space-y-2">
                    ...
                    >
                      <option value="">
                        {t("industries:benefits.selectIndustry")}
                      </option>
                      {INDUSTRIES.map((ind) => (
...
const CreativeCTABanner: React.FC = () => {
  ...
  return (
    <section className="py-32 md:py-48 relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 dark:from-dark dark:via-slate-900 dark:to-dark">
      ...
      <div
        className="absolute bottom-20 right-10 w-40 h-40 bg-secondary/20 rounded-full blur-3xl animate-pulse"
        style={{ animationDelay: "1s" }}
      ></div>
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-cyber/10 rounded-full blur-3xl animate-pulse"
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
        ...
        <h2 className="text-4xl md:text-7xl font-black text-white mb-8 tracking-tighter uppercase transition-colors leading-tight">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-secondary to-cyber">
            ...
            <div className="relative w-72 h-72 md:w-80 md:h-80 flex items-center justify-center">
              ...
              <div className="absolute inset-16 bg-gradient-to-br from-primary to-secondary border border-white/20 rounded-full flex items-center justify-center overflow-hidden transition-all duration-500 group-hover:scale-110 shadow-2xl shadow-primary/30">
                ...
                <div className="flex flex-col items-center z-10 space-y-3">
                  <div
                    className={`text-5xl transition-all duration-500 ${isHovered ? "text-white scale-125" : "text-white/60"}`}
                  >
                    <Icons.Network />
                  </div>
                  <span
                    className={`text-[11px] font-black uppercase tracking-[0.3em] transition-all duration-500 ${isHovered ? "text-white" : "text-white/80"}`}
                  >
                    {isHovered
                      ? t("industries:cta.button.initialize")
                      : t("industries:cta.button.connect")}
                  </span>
                </div>
              </div>
              ...
              {/* Hover Glow */}
              <div
                className={`absolute inset-0 rounded-full bg-primary/30 blur-3xl transition-opacity duration-700 ${isHovered ? "opacity-60" : "opacity-0"}`}
              ></div>
            </div>
          </Link>
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 items-start group">
      <div className={`lg:col-span-5 ${isReversed ? "lg:order-2" : ""}`}>
        <div
          className={`flex flex-col md:flex-row items-start md:items-center ${isRTL ? "md:flex-row-reverse" : ""} space-y-4 md:space-y-0 md:space-x-6 mb-8`}
        >
          <div
        ...
        <p
          className="text-lg md:text-xl text-slate-600 dark:text-gray-400 font-light leading-relaxed mb-10 border-l-2 pl-6 transition-colors"
        ...
        {relatedProjects.length > 0 && (
          <div className="mt-10 pt-8 border-t border-slate-200 dark:border-white/10">
            ...
            >
              ...
              <svg
                className={`w-4 h-4 ml-1 ${isRTL ? "mr-1 ml-0 rotate-180" : ""} group-hover/link:translate-x-1 transition-transform`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
      ...
      <div
        className={`lg:col-span-7 aspect-square md:aspect-[4/3] lg:aspect-square bg-slate-50 dark:bg-dark/40 border border-slate-200 dark:border-white/5 relative flex items-center justify-center overflow-hidden group-hover:border-primary/30 transition-colors duration-500 ${isReversed ? "lg:order-1" : ""}`}
      >
        <div className="absolute inset-0 grid-bg opacity-20"></div>
...
const AbstractVisual: React.FC<{ type: string; accentColor: string }> = ({
  type,
  accentColor,
}) => {
  const colors = {
    ...
    <div className="w-full h-full flex items-center justify-center p-8">
      <svg className="w-4/5 h-4/5" viewBox="0 0 400 400" fill="none">
        ...
        {type === "education" && (
          <>
            <path
              d="M200 50 L200 150 M200 150 L150 250 M200 150 L250 250"
              stroke={colors.accent}
              strokeWidth="2"
              opacity="0.5"
            />
        ...
        {type === "ecommerce" && (
          <>
            ...
            />
            <path
              d="M240 220 L280 220 L280 260 L240 260 Z"
              stroke={colors.accent}
              strokeWidth="1"
