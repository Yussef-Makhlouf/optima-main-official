...
const DetailedProjectCard: React.FC<{ id: string, slug: string, client: string, tags: string[], index: number, t: any, thumbnail?: string }> = ({ id, slug, client, tags, index, t, thumbnail }) => {
