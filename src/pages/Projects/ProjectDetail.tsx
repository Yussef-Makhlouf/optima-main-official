        ...
        <div className="pt-24 md:pt-32 min-h-screen bg-white dark:bg-dark transition-colors">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-end">
                        <div className="lg:col-span-8">
                            <div className="text-primary font-mono font-bold text-[10px] md:text-xs uppercase tracking-[0.5em] mb-4 md:mb-6">CASE_STUDY // {project.client}</div>
                            <h1 className="text-4xl sm:text-6xl md:text-8xl font-black text-slate-900 dark:text-white tracking-tighter leading-none uppercase mb-8">{project.title}</h1>
                        ...
                        <div className="lg:col-span-8 space-y-24 md:space-y-32">
                            ...
                            <div>
                                <h2 className="text-[10px] md:text-xs font-black text-primary uppercase tracking-[0.4em] mb-10 md:mb-12 flex items-center">
                                    <span className="w-6 md:w-8 h-[1px] bg-primary mr-4"></span> 01 / CLIENT CHALLENGE
                                </h2>
                            ...
                            <div>
                                <h2 className="text-[10px] md:text-xs font-black text-primary uppercase tracking-[0.4em] mb-10 md:mb-12 flex items-center">
                                    <span className="w-6 md:w-8 h-[1px] bg-primary mr-4"></span> 02 / IMPLEMENTED SOLUTION
                                </h2>
                                <div className="p-8 md:p-10 bg-primary/5 border border-primary/20 corner-accent transition-colors relative">
                                    <div className="absolute -top-4 -left-4 text-[40px] font-black text-primary/10 select-none">ARCHITECTURE</div>
                            ...
                            <div>
                                <h2 className="text-[10px] md:text-xs font-black text-primary uppercase tracking-[0.4em] mb-10 md:mb-12 flex items-center">
                                    <span className="w-6 md:w-8 h-[1px] bg-primary mr-4"></span> 03 / IMPACT METRICS
                                </h2>
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-slate-200 dark:bg-white/5 border border-slate-200 dark:border-white/5">
                                    <MetricBox label="Efficiency Lift" value="99.9%" />
                                    <MetricBox label="Uptime Standard" value="100%" />
                                    <MetricBox label="Latency Reduction" value="40%" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-4">
                            <div className="lg:sticky lg:top-40 space-y-8 md:space-y-12">
                                <div className="p-8 md:p-10 bg-slate-900 dark:bg-black text-white space-y-8 hud-bracket hud-bracket-tl hud-bracket-br">
                                    <h5 className="text-[10px] font-mono font-bold text-secondary uppercase tracking-[0.3em]">TECHNICAL_SPECS.v4</h5>
            ...
            <section className="py-24 md:py-40 bg-slate-50 dark:bg-dark border-t border-slate-200 dark:border-white/5 transition-colors">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    <h3 className="text-[10px] md:text-xs font-mono font-bold text-secondary uppercase tracking-[0.5em] mb-12">[ NEXT_DEPLOYMENT ]</h3>
                    <Link to={`/projects/${PROJECTS[(PROJECTS.indexOf(project) + 1) % PROJECTS.length].slug}`} className="group inline-block">
