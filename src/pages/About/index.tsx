                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-24">
                        ...
                        <div className="lg:col-span-7 space-y-24">
                            <ValueBlock title={t('about:page.values.redundancy.title')} desc={t('about:page.values.redundancy.description')} />
                            <ValueBlock title={t('about:page.values.integrity.title')} desc={t('about:page.values.integrity.description')} />
                            <ValueBlock title={t('about:page.values.scale.title')} desc={t('about:page.values.scale.description')} />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
                        <div>
                            ...
                            <div className="text-[9px] font-black text-slate-400 dark:text-gray-500 uppercase tracking-[0.4em] transition-colors">{t('about:page.stats.availability')}</div>
                        </div>
                        <div>
                            ...
                            <div className="text-[9px] font-black text-slate-400 dark:text-gray-500 uppercase tracking-[0.4em] transition-colors">{t('about:page.stats.operations')}</div>
                        </div>
                        <div>
                            ...
                            <div className="text-[9px] font-black text-slate-400 dark:text-gray-500 uppercase tracking-[0.4em] transition-colors">{t('about:page.stats.deployments')}</div>
                        </div>
                        <div>
                            ...
                            <div className="text-[9px] font-black text-slate-400 dark:text-gray-500 uppercase tracking-[0.4em] transition-colors">{t('about:page.stats.partnerships')}</div>
                        </div>
                    </div>
                </div>
            </section>
