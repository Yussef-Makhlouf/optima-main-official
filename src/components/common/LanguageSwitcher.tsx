...
const LanguageSwitcher: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            {/* HUD Brackets */}
            <div className="absolute top-0 left-0 w-2 h-2 border-t border-l border-secondary/30 group-hover:border-secondary transition-colors"></div>
            <div className="absolute bottom-0 right-0 w-2 h-2 border-b border-r border-secondary/30 group-hover:border-secondary transition-colors"></div>

            {/* Language Text */}
            <div className="relative flex items-center space-x-2 font-mono text-xs font-bold tracking-wider z-10">
