...
import { Octahedron, Icosahedron, MeshDistortMaterial, Environment } from '@react-three/drei';
...
const CrystalShape: React.FC<CrystalProps> = ({
    ...
    return (
        <group position={position} scale={scale}>
            ...
            {/* Point lights */}
            <pointLight color={color} intensity={hovered ? 2 : 1} distance={4} decay={2} position={[0, 1, 0]} />
            <pointLight color={color} intensity={hovered ? 1 : 0.5} distance={3} decay={2} position={[0, -1, 0]} />
        </group>
    );
};

const InteractiveCrystal: React.FC = () => {
    return (
